...
public class Queen implements Pieces {
    ...
    public final Annotation annotation = Annotation.Queen;

    public Queen(Pair position, Colors color) {
    ...
    //needs work - instancing here is stupid
    @Override
    public List<Pair> getValidMoves(Square[][] squareList, boolean controlCheckLogic) {
        ...
        validMoves.addAll(RookMovement.getRookStyleMoves(this.getPosition(), this.getColor(), squareList));

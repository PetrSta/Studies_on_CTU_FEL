...
class BlackPawnCheckLogicTest {
    //setting up pawn for testing
    Pair pawnPosition = new Pair(3, 4);
    Pawn testPawn = new Pawn(pawnPosition, Colors.blackColor);
    ...
    Square[][] createTestBoard() {
        ...
        //test pieces
        squareList[2][3].pieceInstance = new Knight(new Pair(2, 3), Colors.whiteColor);
        squareList[4][4].pieceInstance = new King(new Pair(4, 4), Colors.blackColor);
        squareList[4][1].pieceInstance = new King(new Pair(4, 1), Colors.whiteColor);
        Board.setWhiteKingPosition(new Pair(4, 1));
        Board.setBlackKingPosition(new Pair(4, 4));
        return squareList;
    }
